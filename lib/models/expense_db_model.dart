...
class ExpenseDbModel {
  ...
  ExpenseDbModel._privateConstructor();
  static final ExpenseDbModel instance = ExpenseDbModel._privateConstructor();
  ...
  Future<int> sum(String string) async {
    Database db = await instance.database;
    return Sqflite.firstIntValue(await db.rawQuery('SELECT SUM($columnAmount) FROM $table WHERE $columnType = ? GROUP BY $columnType', [string],));
  }
